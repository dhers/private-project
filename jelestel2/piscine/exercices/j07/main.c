...
UT_TEST(ft_range)
{
	int	tab_ref[5]={7, 8, 9, 10, 11};
	int	*tab;

	tab = ft_range(7, 12);
	UT_ASSERT_EQ(ft_strcmp_int(tab, tab_ref, 5), 0);
}

UT_TEST(ft_ultimate_range)
{
	int	tab_ref[5] = {7, 8, 9, 10, 11};
	int	**tab;
	int	*test;
	...
	test = &i;
	tab = &test;
	i = ft_ultimate_range(tab, 7, 12);
	UT_ASSERT_EQ(i, 5);
	UT_ASSERT_EQ(ft_strcmp_int(*tab, tab_ref, 5), 0);
}

UT_TEST(ft_concat_params)
{
	char str0[] = "./a.out";
	char str1[] = "test ";
	char str2[] = "de ";
	...
	char *argv[7];
	char *str_test;
	char str_ref[] = "test de concats params du main.";
	argv[0] = str0;
	argv[1] = str1;
	argv[2] = str2;
	argv[3] = str3;
	...
	argv[5] = str5;
	argv[6] = str6;
	str_test = ft_concat_params(7, argv);
	UT_ASSERT_EQ(strcmp(str_test, str_ref), 0);
}
/*
UT_TEST(ft_strcpy)
{
...
int	main(void)
{
	...
	UT_ADD_TEST(ft_range);
	UT_ADD_TEST(ft_ultimate_range);
	UT_ADD_TEST(ft_concat_params);
